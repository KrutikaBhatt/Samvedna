...
export const Navbar = ({setUserId, setUserName, setWalletAddress, userId, isModerator, setIsModerator, isTherapist, setIsTherapist}) => {
  const login = async () => {
    if (window.ethereum) {
      var accounts;
			try {
      ...
      setIsModerator(data.data.user.is_moderator)
      setIsTherapist(data.data.user.is_therapist)
    }
  }
          ...
          <ul class="space-y-2 font-medium">
            ...
            <li>
              <a
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">My Progress</span>
            ...
            { isModerator && <li>
              <Link
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Add Moderator</span>
              </Link>
            </li>}
            {!userId && 
            <><li>
